...
<a href="tambahdata.php" type="button" class="add-button"> Add New</a><br><br>
<div class="table-container">
            <center>
            <h3 class="mb-4">Data Barang Masuk</h3>
            <center>
                    <div class="card-body">
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)){
              ...
              <tr>
                ...
                <td>
                  <a href= "editbarang.php?IdBarang=<?php echo $row["IdBarang"]?>" class="add-button">Edit</a>
                  <a href= "deletebarang.php?IdBarang=<?php echo $row["IdBarang"]?>" class="add-button">Delete</a>
            </td>
            </tr>
            <?php
            }
